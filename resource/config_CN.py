...
resource_dir = "C:/阴阳师脚本文件/资源文件"


class BattleWin:
    _sub_dir = os.path.abspath(os.path.join(resource_dir, "战斗结算"))
    _win1 = "战斗结束之轮子.bmp"
    _win2 = "战斗结束之碗.bmp"
    _win3 = "战斗结束之点击任意键.bmp"
    _win4 = "战斗结束之勾玉.bmp"
    x_click_win = 0
    y_click_win = 200
    random_x = 180
...
class BattleLose:
    _sub_dir = os.path.abspath(os.path.join(resource_dir, "战斗失败"))
    _lose1 = "失败.bmp"
    random_x = 150
    random_y = 25
...
class BattleStart:
    _sub_dir = os.path.abspath(os.path.join(resource_dir, "战斗开始"))
    _start = "开始战斗.bmp"
    _ready = "准备圆盘.bmp"
    random_x = 150
    random_y = 25
...
class RefuseGoldOffer:
    _sub_dir = os.path.abspath(os.path.join(resource_dir, "悬赏封印"))
    _refuse_button = "悬赏拒绝.bmp"
    _accept_button = "悬赏接受.bmp"
    _gouyu = "勾协.bmp"
    # 找到悬赏图后，一次轮回中尝试
    check_times = 3
    random_x = 150
...
class Invitation:
    _sub_dir = os.path.abspath(os.path.join(resource_dir, "接收邀请"))
    _invitation = "邀请叉勾.bmp"
...
class Back:
    _sub_dir = os.path.abspath(os.path.join(resource_dir, "返回逻辑"))
    _story = "探索返回.bmp"
    _boundary = "结界返回.bmp"
    _confirm = "确认.bmp"
    random_x = 25
